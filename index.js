...
var startAtLine = 117481; //61068set this to last line in case job interrupted 
if (indexesAreNotSet) {
...
neodb.cypherQuery(query, function (err, result){
  if (err) { 
      console.log ("got this query error:  ",err);    
         ...
         if (verbose) console.log ("got the index set callback ... ", result);
       neodb.listNodeIndexes(function (err, result){
      if (err) { 
      console.log ("got this list error:  ",err);    
      }else{ 
        console.log ("list index result:  ", result ); 
